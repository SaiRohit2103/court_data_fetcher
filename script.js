...
class CourtDataFetcher {
    ...
    async handleFormSubmit(e) {
        ...
        if (!this.validateForm(searchData)) return;
        if (!this.validateCaptchaForm()) return;
    ...
    renderCaseDetails(caseInfo) {
        ...
        caseDetails.innerHTML = `
            <div class="case-detail-item"><span class="case-detail-label">Case Number:</span><span class="case-detail-value">${caseInfo.caseNumber}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Court:</span><span class="case-detail-value">${caseInfo.court}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Filing Date:</span><span class="case-detail-value">${caseInfo.filingDate}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Status:</span><span class="case-detail-value">${caseInfo.status}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Petitioner:</span><span class="case-detail-value">${caseInfo.petitioner}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Respondent:</span><span class="case-detail-value">${caseInfo.respondent}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Last Hearing:</span><span class="case-detail-value">${caseInfo.lastHearing}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Next Hearing:</span><span class="case-detail-value">${caseInfo.nextHearing}</span></div>
            <div class="case-detail-item"><span class="case-detail-label">Judge:</span><span class="case-detail-value">${caseInfo.judge}</span></div>
        `;
    }
